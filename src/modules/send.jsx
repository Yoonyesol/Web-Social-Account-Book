...
const [SEND_CHAT, SEND_CHAT_SUCCESS, SEND_CHAT_FAILURE] = createRequestActionTypes("send/SEND_CHAT");
...
export const sendChat = createAction(SEND_CHAT, ({ sender, receiver, content }) => ({
  sender,
  receiver,
  content,
}));
